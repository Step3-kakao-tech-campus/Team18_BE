...
public class ContactResponse {
    ...
    public static class ContactDashBoardMenteeDTO {
        ...
        public ContactDashBoardMenteeDTO(MentoringBoard mentoringBoard, ContactMentorDTO writerDTO, NotConnectedRegisterUser notConnectedRegisterUser) {
    ...
    public static class ContactDashboardMentorDTO {
        ...
        public ContactDashboardMentorDTO(MentoringBoard mentoringBoard, ContactMentorDTO writerDTO, List<ConnectionDTO> mentees) {
            this.postId = mentoringBoard.getId();
            this.title = mentoringBoard.getTitle();
            this.writerDTO = writerDTO;
